...
liquidCDAddress = "0x1512128b84ec23f2d409cB3230D433f3EF75799e";//change this one
...
function tokensOfOwner(userAddress) {
    liquidCD.tokensOfOwner(userAddress, (err, res) => {
        if (!err) {
            ...
            var tokens = usersTokens.sort(function (a, b) {  return a - b;  });
